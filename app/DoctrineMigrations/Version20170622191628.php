 ...
 */
class Version20170622191628 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE provider (id INT AUTO_INCREMENT NOT NULL, provider_type_id INT NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, is_freelance TINYINT(1) NOT NULL, is_avalaible TINYINT(1) NOT NULL, siret VARCHAR(255) NOT NULL, iban VARCHAR(255) NOT NULL, range_distance INT NOT NULL, UNIQUE INDEX UNIQ_92C4739CE7927C74 (email), INDEX IDX_92C4739C35142E34 (provider_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
